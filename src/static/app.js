              ...
              .map(
                (participant) => `
                  <li>
                    ...
                    <button class="delete-participant" type="button" data-activity="${name}" data-participant="${participant}" aria-label="Unregister ${participant} from ${name}" title="Unregister participant">&#128465;</button>
                  </li>`
              )
              .join("")
